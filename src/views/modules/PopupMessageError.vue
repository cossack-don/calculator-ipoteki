<template>
  <div class="popup-message-error">
    <div class="popup-message-error__header">
      <h3 class="popup-message-error__title">
        Внимание! <br />
        <span class="popup-message-error__title-span"
          >Заполните все нижеперечисленные поля:</span
        >
      </h3>
      <div class="popup-message-error__btn-close" @click="closePopup">
        <svg
          height="512pt"
          viewBox="0 0 512 512"
          width="512pt"
...
export default {
  methods: {
    ...
    closePopup() {
      this.ACTIONS_TOGGLE_MODAL_POPUP();
    },
  },
};
</script>
